...
fun AppTheme(
    ...
    // Se deja en false para usar SIEMPRE tu tema personalizado (verde).
    // Con true, en Android 12+ se usarían los colores del sistema y no se
    // vería tu paleta de Material Theme Builder.
